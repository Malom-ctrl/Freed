...
const ASSETS = [
  ...
  "./features/article-list/article-list.css",
  "./features/reader/reader-view.css",
  "./features/discover/discover-view.css",
  "./features/settings/settings-modal.css",
  "./features/stats/stats-view.css",
  "./features/plugin-system/manager-view.css",
  ...
  "./features/article-list/article-list.js",
  "./features/reader/cad-manager.js",
  ...
  "./features/plugin-system/manager-view.js",
  // Fonts
