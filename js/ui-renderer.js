...
window.Freed.UI = {
    ...
    renderArticles: function(articles, onOpen, showImages = true) {
        ...
        if (articles.length === 0) {
            ...
            const hasFilters = document.getElementById('filter-status')?.value !== 'all' || 
        ...
        articles.forEach((article) => {
            ...
            const feedTitleStyle = article.feedColor ? `style="color: ${article.feedColor}"` : '';
